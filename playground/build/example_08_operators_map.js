...
var albums = [{
    title: 'Album 1', tracks: [{ id: 1, title: 'Track 1.1' }, { id: 2, title: 'Track 1.2' }]
}, {
    title: 'Album 2', tracks: [{ id: 1, title: 'Track 2.1' }, { id: 2, title: 'Track 2.2' }]
}];
 ...
 */
_Rx2.default.Observable.of([{ id: 1, title: 'Track 1.1' }, { id: 2, title: 'Track 1.2' }, { id: 3, title: 'Track 1.3' }], [{ id: 1, title: 'Track 2.1' }, { id: 2, title: 'Track 2.2' }, { id: 3, title: 'Track 2.3' }], [{ id: 1, title: 'Track 3.1' }, { id: 2, title: 'Track 3.2' }, { id: 3, title: 'Track 3.3' }])
// .mergeMap(tracks => Rx.Observable.from(tracks))
.switchMap(function (tracks) {
    return _Rx2.default.Observable.from(tracks);
}).map(function (track) {
    return track.id + ' -- ' + track.title;
}).subscribe((0, _util.createSubscriber)('mergeMap-promise'));